export const ui = {
  en: {
    ...
    'home.intro': 'Hi. My name is Sasha. I am a mathematician by training and have spent the last 10+ years developing geometry software. In my free time I read books and articles on mathematics and algorithms. This site is my personal collection of notes and ideas that I found interesting.',
  ...
  ru: {
    ...
    'home.intro': 'Привет. Меня зовут Саша. Я занимаюсь разработкой программ, связанных с геометрией, уже более 10 лет. Математик по образованию. В свободное время читаю книги и статьи по математике и алгоритмам. Этот сайт — мой личный сборник заметок и идей, которые показались мне интересными.',
